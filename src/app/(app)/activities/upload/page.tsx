...
export default function UploadPage() {
  ...
  return (
    <div>
      ...
      <p className="opacity-70 mb-6">Attach the .fit file from your watch or bike computer.</p>
      ...
      {stage === 'idle' && (
        <>
          ...
          >
            ...
            <div className="font-semibold">Drag your .fit file here, or click to browse</div>
            <div className="text-text/60 text-[13px] mt-1">
              (Demo: click anywhere in this area to preview a parsed upload)
            </div>
          </div>
