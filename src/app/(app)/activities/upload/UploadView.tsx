...
export function UploadView({ initialWorkoutId }: { initialWorkoutId?: string }) {
  ...
  const [workoutId, setWorkoutId] = useState(initialWorkoutId ?? 'none')
  ...
  function resetSelection() {
    ...
    setAthleteNote('')
    setDifficultyNote('')
    setWorkoutId(initialWorkoutId ?? 'none')
  }
